...
document.getElementById('save').onclick = ()=>{
    ...
    localStorage.setItem('fNewnote4',Note);
    localStorage.setItem('fntitle4',title);
    localStorage.setItem('fndate4',date);
    console.log("saved");
    document.getElementById('savedpopup').style.display = 'inline';
}
function LoadNote(){
    let SavedNote = localStorage.getItem('fNewnote4');
    let title = localStorage.getItem('fntitle4');
    let date = localStorage.getItem('fndate4');
...
document.getElementById('delete').onclick = ()=>{
    localStorage.clear('fNewnote4');
    localStorage.clear('fndate4');
    localStorage.clear('fntitle4');
