...
document.getElementById('save').onclick = ()=>{
    ...
    localStorage.setItem('Newnote',Note);
    localStorage.setItem('ntitle',title);
    localStorage.setItem('ndate',date);
    console.log("saved");
    document.getElementById('savedpopup').style.display = 'inline';
}
function LoadNote(){
    let SavedNote = localStorage.getItem('Newnote');
    let title = localStorage.getItem('ntitle');
    let date = localStorage.getItem('ndate');
...
document.getElementById('delete').onclick = ()=>{
    ...
    localStorage.clear('ndate');
    localStorage.clear('ntitle');
