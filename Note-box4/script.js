...
document.getElementById('save').onclick = ()=>{
    ...
    localStorage.setItem('Newnote4',Note);
    localStorage.setItem('ntitle4',title);
    localStorage.setItem('ndate4',date);
    console.log("saved");
    document.getElementById('savedpopup').style.display = 'inline';
}
function LoadNote(){
    let SavedNote = localStorage.getItem('Newnote4');
    let title = localStorage.getItem('ntitle4');
    let date = localStorage.getItem('ndate4');
...
document.getElementById('delete').onclick = ()=>{
    localStorage.clear('Newnote4');
    localStorage.clear('ndate4');
    localStorage.clear('ntitle4');
