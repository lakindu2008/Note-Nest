...
document.getElementById('save').onclick = ()=>{
    ...
    localStorage.setItem('fNewnote2',Note);
    localStorage.setItem('fntitle2',title);
    localStorage.setItem('fndate2',date);
    console.log("saved");
    document.getElementById('savedpopup').style.display = 'inline';
}
function LoadNote(){
    let SavedNote = localStorage.getItem('fNewnote2');
    let title = localStorage.getItem('fntitle2');
    let date = localStorage.getItem('fndate2');
...
document.getElementById('delete').onclick = ()=>{
    localStorage.clear('fNewnote2');
    localStorage.clear('fndate2');
    localStorage.clear('fntitle2');
