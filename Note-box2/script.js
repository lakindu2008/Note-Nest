...
document.getElementById('save').onclick = ()=>{
    ...
    localStorage.setItem('Newnote2',Note);
    localStorage.setItem('ntitle2',title);
    localStorage.setItem('ndate2',date);
    console.log("saved");
    document.getElementById('savedpopup').style.display = 'inline';
}
function LoadNote(){
    let SavedNote = localStorage.getItem('Newnote2');
    let title = localStorage.getItem('ntitle2');
    let date = localStorage.getItem('ndate2');
...
document.getElementById('delete').onclick = ()=>{
    localStorage.clear('Newnote2');
    localStorage.clear('ndate2');
    localStorage.clear('ntitle2');
