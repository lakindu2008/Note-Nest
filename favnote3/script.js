...
document.getElementById('save').onclick = ()=>{
    ...
    localStorage.setItem('fNewnote3',Note);
    localStorage.setItem('fntitle3',title);
    localStorage.setItem('fndate3',date);
    console.log("saved");
    document.getElementById('savedpopup').style.display = 'inline';
}
function LoadNote(){
    let SavedNote = localStorage.getItem('fNewnote3');
    let title = localStorage.getItem('fntitle3');
    let date = localStorage.getItem('fndate3');
...
document.getElementById('delete').onclick = ()=>{
    localStorage.clear('fNewnote3');
    localStorage.clear('fndate3');
    localStorage.clear('fntitle3');
