...
document.getElementById('save').onclick = ()=>{
    ...
    localStorage.setItem('fNewnote1',Note);
    localStorage.setItem('fntitle1',title);
    localStorage.setItem('fndate1',date);
    console.log("saved");
    document.getElementById('savedpopup').style.display = 'inline';
}
function LoadNote(){
    let SavedNote = localStorage.getItem('fNewnote1');
    let title = localStorage.getItem('fntitle1');
    let date = localStorage.getItem('fndate1');
...
document.getElementById('delete').onclick = ()=>{
    localStorage.clear('fNewnote1');
    localStorage.clear('fndate1');
    localStorage.clear('fntitle1');
