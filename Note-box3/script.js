...
document.getElementById('save').onclick = ()=>{
    ...
    localStorage.setItem('Newnote3',Note);
    localStorage.setItem('ntitle3',title);
    localStorage.setItem('ndate3',date);
    console.log("saved");
    document.getElementById('savedpopup').style.display = 'inline';
}
function LoadNote(){
    let SavedNote = localStorage.getItem('Newnote3');
    let title = localStorage.getItem('ntitle3');
    let date = localStorage.getItem('ndate3');
...
document.getElementById('delete').onclick = ()=>{
    localStorage.clear('Newnote3');
    localStorage.clear('ndate3');
    localStorage.clear('ntitle3');
